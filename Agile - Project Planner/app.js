...
` +
  ...
  function kM({ store: e, select: t, onChange: r, comparator: n = DM }) {
  ...
  function Yh({ actionGroup: e, event: t, elementApi: r }) {
    ...
    n.forEach((i) => {
      ...
      Ft(o)
        ? (s = (u) => Ma(o)(u, i))
        : (s = oy({ effect: dD, actionTypeId: o, elementApi: r })),
  ...
  var gt,
    ...
    uy = he(() => {
      ...
      ({
        ...
        (ty = (e) => e.trim()),
        (Ha = Object.freeze({ [cr]: Qh, [lr]: wM, [fr]: AM })),
        (ry = Object.freeze({
          [wt]: hM,
          [Qh]: gM,
          [ni]: ni,
          ...
          switch (t.type) {
            ...
            case SD: {
              ...
              return (0, ht.set)(e, r, {
                ...
                skipToValue: X,
                customEasingFn:
                  Array.isArray(x) && x.length === 4 ? ND(x) : void 0,
              });
            }
            case CD: {
  ...
  var Am,
    ...
    pi = he(() => {
      ...
      (Am = le(kt())),
        ...
        ({ reifyState: Ak } = Am.IX2VanillaUtils),
        (Ja = (e) => ({ type: ak, payload: { ...Ak(e) } })),
        ...
        (Ck = (e) => ({ type: dk, payload: { actionListId: e } })),
        (Rk = () => ({ type: pk })),
        (li = (e, t) => ({
          type: vk,
          payload: { target: e, listenerParams: t },
        })),
        (Lk = (e = 1) => ({ type: gk, payload: { step: e } })),
        (ns = (e, t) => ({ type: hk, payload: { stateKey: e, newState: t } })),
        (fi = (e, t) => ({ type: yk, payload: { now: e, parameters: t } })),
        (pr = (e, t) => ({ type: mk, payload: { key: e, value: t } })),
        (is = (e) => ({ type: Ek, payload: { ...e } })),
        (di = (e, t) => ({ type: _k, payload: { instanceId: e, time: t } })),
        (os = (e) => ({ type: bk, payload: { instanceId: e } })),
        (as = (e, t, r, n) => ({
          type: Tk,
  ...
  var gs = c((Nj, yE) => {
    ...
    function AG(e) {
      for (
        var t = e.name + "", r = hE[t], n = wG.call(hE, t) ? r.length : 0;
        n--;
  ...
  var TE = c((Fj, bE) => {
    ...
    function qG(e) {
      ...
      return (
        (t.__actions__ = PG(e.__actions__)),
  ...
  var jE,
    ...
    a_ = he(() => {
      ...
      (YE = le(kt())),
        ...
        (SV = t_(({ element: e, nativeEvent: t }) => e.contains(t.target))),
        (lt = (0, jE.default)([Jr, SV])),
        (r_ = (e, t) => {
          if (t) {
            let { ixData: r } = e.getState(),
              { events: n } = r,
        ...
        (_s = { types: Es }),
        (RV = { PAGE_START: JE, PAGE_FINISH: ZE }),
        (Zr = (() => {
        ...
        (o_ = {
          ...
          [yV]: _i(),
          [mV]: bi(),
          [AV]: { types: "ecommerce-cart-open", handler: et(lt, Ue) },
          [wV]: { types: "ecommerce-cart-close", handler: et(lt, Ue) },
          [sV]: {
            types: "click",
            handler: et(
              lt,
  ...
  function sU(e, t) {
    ...
    if (n && i && y && s) {
      ...
      g && (y = jV({ actionList: g, actionItemId: i, rawData: y }));
    }
    if (
  ...
  function xi({ store: e, rawData: t, allowEvents: r, testManual: n }) {
    ...
    t && e.dispatch(Ja(t)),
      i.active ||
        ...
        r &&
          (gU(e), lU(), e.getState().ixSession.hasDefinedMediaQueries && iU(e)),
        e.dispatch(ts()),
        fU(e, n));
  }
  function lU() {
  ...
  function bU({ logic: e, store: t, events: r }) {
    ...
    (0, hr.default)(s, (g, v) => {
      ...
      ZV(C, o.mediaQueryKeys) || t.dispatch(us()),
  ...
  var c_,
    ...
    bs = he(() => {
      ...
      (mU = (e, t) => (0, f_.default)((0, p_.default)(e, t), d_.default)),
        (EU = (e, t) => {
          (0, hr.default)(e, (r, n) => {
            r.forEach((i, o) => {
              let a = n + Is + o;
...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        id: "66387a3413c4861ac784509e|2ea7be02-2e1a-7f02-a09f-118bc159736b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-3": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66387a3413c4861ac784509e|53c675f4-3383-a9da-d23b-5479182b84bf",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-5": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66387a3413c4861ac784509e|3249955b-9f5d-73bd-c54e-24580755f863",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-7": {
      ...
      target: {
        selector: ".link-block",
        originalId:
          "66387a3413c4861ac784509e|e13000ae-ac45-2dce-f543-31f922aca4ab",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-15": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "66387a3413c4861ac784509e|d258783c-00c8-552a-ff72-9c830fd8c2b8",
      },
      targets: [],
      config: {
        loop: false,
    ...
    "e-17": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "66387a3413c4861ac784509e|ad42ca0c-b51b-37df-c8f6-545a188f4231",
      },
      targets: [],
      config: {
        loop: false,
    ...
    "e-19": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "66387a3413c4861ac784509e|851edd38-10a4-4247-3749-167ff2a4bde9",
      },
      targets: [],
      config: {
        loop: false,
  ...
  actionLists: {
    a: {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".image-2",
                  selectorGuids: ["187ac0bc-b986-31a6-217f-8edc3619df00"],
                },
                xValue: 8,
                xUnit: "px",
                yUnit: "PX",
      ...
      createdOn: 1715369869644,
    },
    "a-2": {
      id: "a-2",
      title: "arrow gets back",
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["65db477b-d95f-8a9a-3004-f87600f22443"],
                },
                value: 0,
                unit: "",
              },
